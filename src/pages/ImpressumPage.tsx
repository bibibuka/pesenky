...
const pageT = {
  de: {
    ...
    sections: [
      ...
      { title: 'Verantwortlich für den Inhalt', content: 'Alina Voronova\n8200 Schaffhausen' },
      ...
      { title: 'Urheberrechte', content: 'Die Urheber- und alle anderen Rechte an Inhalten, Bildern, Fotos oder anderen Dateien auf dieser Website, gehören ausschliesslich Alina Voronova oder den speziell genannten Rechteinhabern. Für die Reproduktion jeglicher Elemente ist die schriftliche Zustimmung des Urheberrechtsträgers im Voraus einzuholen.' },
    ],
  },
  en: {
    title: 'Imprint',
    sections: [
      ...
      { title: 'Responsible for Content', content: 'Alina Voronova\n8200 Schaffhausen' },
      ...
      { title: 'Copyright', content: 'The copyright and all other rights to content, images, photos or other files on this website belong exclusively to Alina Voronova or the specifically named rights holders. Written consent of the copyright holder must be obtained in advance for the reproduction of any elements.' },
    ],
  },
  ru: {
    title: 'Импринт',
    sections: [
      ...
      { title: 'Ответственный за содержание', content: 'Алина Воронова\n8200 Шаффхаузен' },
      ...
      { title: 'Авторские права', content: 'Авторские и все другие права на содержание, изображения, фотографии и файлы на этом сайте принадлежат исключительно Алине Вороновой. Для воспроизведения любых элементов требуется предварительное письменное согласие правообладателя.' },
    ],
  },
};
